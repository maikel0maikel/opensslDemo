...
void start_stun(JNIEnv*env,jobject obj,jlong native_ptr,jstring addr,jint port,jobject observer){
...
void startuclient(JNIEnv *env, jobject thiz, jlong native_ptr,jstring address, jint port,jstring u_name, jstring u_pwd,
    jobject observer) {
    coturn_manager* manager = reinterpret_cast<coturn_manager *>(native_ptr);
